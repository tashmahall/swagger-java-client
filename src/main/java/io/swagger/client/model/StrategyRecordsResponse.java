...
public class StrategyRecordsResponse   {
  @JsonProperty("records")
  @Valid
  private List<Strategy> records = null;

  public StrategyRecordsResponse records(List<Strategy> records) {
    this.records = records;
    return this;
  }

  public StrategyRecordsResponse addRecordsItem(Strategy recordsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StrategyRecordsResponse strategyRecords = (StrategyRecordsResponse) o;

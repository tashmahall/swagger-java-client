...
public class ApiClient {
    ...
    private String basePath = "https://apisim.flexscan.com.br";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apisim.flexscan.com.br
    ...
    public static boolean isJsonMime(String mime) {
    	String jsonMime = "(?i)^application\\/json\\b";
      Pattern pat =Pattern.compile(jsonMime);
      Matcher mat = pat.matcher(mime);
      return mime != null && (mime.matches(jsonMime) || mime.equals("*/*"));
    }
    public static void main (String[] ac) {
    	
    	System.out.println(ApiClient.isJsonMime("application/JSON#sodre"));
    }
    /**
